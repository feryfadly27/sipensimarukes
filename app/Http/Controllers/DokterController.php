...
class DokterController extends Controller
{
    ...
    public function store(Request $request, Mahasiswa $mahasiswa)
    {
        ...
        $validated = $request->validate([
            ...
            'mata_minus_nilai_kiri' => 'nullable|numeric|required_if:mata_minus,1',
            'mata_minus_nilai_kanan' => 'nullable|numeric|required_if:mata_minus,1',
            'mata_silindris' => 'required|boolean',
            'mata_silindris_nilai_kiri' => 'nullable|numeric|required_if:mata_silindris,1',
            'mata_silindris_nilai_kanan' => 'nullable|numeric|required_if:mata_silindris,1',
